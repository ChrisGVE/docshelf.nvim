...
local adapters = {}
for _, adapter in ipairs({ require("apidocs.sources.devdocs"), require("apidocs.sources.docsrs"), require("apidocs.sources.hackage"), require("apidocs.sources.sphinx") }) do
