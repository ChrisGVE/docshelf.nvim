...
local adapters = {}
for _, adapter in ipairs({ require("docshelf.sources.devdocs"), require("docshelf.sources.docc"), require("docshelf.sources.docsrs"), require("docshelf.sources.hackage"), require("docshelf.sources.pkggodev"), require("docshelf.sources.sphinx") }) do
